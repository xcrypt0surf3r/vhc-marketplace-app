...
const NewestItems = () => {
  return (
    <div className='bg-white'>
      <div className='max-w-2xl mx-auto pt-10 pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8 lg:pt-0'>
        ...
        <div className='mt-6 grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-10 sm:gap-x-6 lg:gap-x-8'>
          {assets.map((asset) => (
            <AssetCard
              key={asset.id}
              id={asset.id}
