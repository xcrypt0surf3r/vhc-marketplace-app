...
const Promotion = () => {
  return (
    <div className='bg-gray-100 max-w-[76rem] m-auto rounded-2xl'>
      <div className='relative'>
        <div className='w-full h-28 sm:h-52 lg:absolute lg:top-0 lg:left-24 lg:w-[35%] lg:h-[19.5rem]'>
          <img
            src={community}
            alt=''
        ...
        <div className='relative bg-gray-100 lg:bg-transparent'>
          <div className='max-w-7xl px-4 sm:px-6 lg:pl-[30rem]'>
            <div className='max-w-2xl mx-auto py-14 lg:py-14 lg:max-w-xl'>
              <div className='text-xl lg:pl-12 xl:pl-16 lg:block lg:text-left text-center flex flex-col items-center'>
