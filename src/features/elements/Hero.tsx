...
import { SearchBar } from '../shared/headers/modules'
    ...
    <div className='bg-white flex flex-col justify-center'>
      <div className='max-w-7xl mx-auto py-5 px-4 sm:px-6 md:py-10 lg:px-8 lg:py-24 lg:pt-0'>
        <h2 className='text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl mb-3'>
          <span className='block mb-3 md:mb-0 text-center md:inline'>
            {'Inspect, Buy, and Sell'}
          </span>{' '}
          <span className='block text-center md:inline text-blue-500'>
            Virtual Lands
          </span>
        </h2>
